...
RUN apt-get update && apt-get upgrade -y && apt-get install -y build-essential automake zsh wget curl git silversearcher-ag nodejs neovim docker.io && curl -sS https://dl.yarnpkg.com/debian/pubkey.gpg | apt-key add - && echo "deb https://dl.yarnpkg.com/debian/ stable main" | tee /etc/apt/sources.list.d/yarn.list && apt-get update && apt-get install -y yarn
...
RUN git clone https://github.com/tmux/tmux.git && cd tmux && sh autogen.sh && ./configure && make && make install && cd .. && rm -rf tmux
